...
\hypersetup{
  pdftitle={UNFCCC Emissions Data Cleaning Tutorial},
  hidelinks,
...
\NormalTok{unfccc\_emissions}\SpecialCharTok{$}\NormalTok{iso[unfccc\_emissions}\SpecialCharTok{$}\NormalTok{country }\SpecialCharTok{==} 
    \StringTok{"Democratic Republic of the Congo"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"COG"}

\FunctionTok{rm}\NormalTok{(region)}
\end{Highlighting}
\end{Shaded}
